...
Boot now: read LLaves, probe to confirm hands (report the real allowlist), read the 5 docs (report the real next action), then tell the operator you're oriented + the current state and the single next action in a few lines.
